import type { CourseCriteriaSummary, Criterion } from "@/types";

type CriteriaRatingsProps = {
  summary: CourseCriteriaSummary[];
  criteria: Criterion[];
};

function getLabelForValue(criterion: Criterion, avg: number): string {
  if (avg <= 0) return "—";
...
export function CriteriaRatings({ summary, criteria }: CriteriaRatingsProps) {
  return (
